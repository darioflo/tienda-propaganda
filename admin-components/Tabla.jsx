...
export default function Tabla({ thead }) {
    ...
    const { setMostrarTiendas, setVerAdministradores, contadorEnvios, editarTiendas, setEditarTiendas, editarAdmines, setEditarAdmines } = useContext(adminContext)
    ...
    const mostrarInformacionTotal = async (id) => {
        console.log(id);
    }
